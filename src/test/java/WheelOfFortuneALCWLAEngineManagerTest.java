...
public class WheelOfFortuneALCWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(WheelOfFortuneALCWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/WheelOfFortuneALCIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/WheelOfFortuneALCIW/InitOutcome.xml").getDocumentElement();
